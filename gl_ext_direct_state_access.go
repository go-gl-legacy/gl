...
// Make member?
func CheckNamedFramebufferStatus(framebuffer uint, target GLenum) GLenum {
...
// Make member?
func CompressedTextureImage1D(texture uint, target GLenum, level int, internalformat GLenum, width int, border int, imageSize int, data interface{}) {
...
// Make member?
func CompressedTextureImage2D(texture uint, target GLenum, level int, internalformat GLenum, width int, height int, border int, imageSize int, data interface{}) {
...
// Make member?
func CompressedTextureImage3D(texture uint, target GLenum, level int, internalformat GLenum, width int, height int, depth int, border int, imageSize int, data interface{}) {
...
// Make member?
func CompressedTextureSubImage1D(texture uint, target GLenum, level int, xoffset int, width int, format GLenum, imageSize int, data interface{}) {
...
// Make member?
func CompressedTextureSubImage2D(texture uint, target GLenum, level int, xoffset int, yoffset int, width int, height int, format GLenum, imageSize int, data interface{}) {
...
// Make member?
func CompressedTextureSubImage3D(texture uint, target GLenum, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format GLenum, imageSize int, data interface{}) {
...
// Make member?
func CopyTextureImage1D(texture uint, target GLenum, level int, internalformat GLenum, x int, y int, width int, border int) {
...
// Make member?
func CopyTextureImage2D(texture uint, target GLenum, level int, internalformat GLenum, x int, y int, width int, height int, border int) {
...
// Make member?
func CopyTextureSubImage1D(texture uint, target GLenum, level int, xoffset int, x int, y int, width int) {
...
// Make member?
func CopyTextureSubImage2D(texture uint, target GLenum, level int, xoffset int, yoffset int, x int, y int, width int, height int) {
...
// Make member?
func CopyTextureSubImage3D(texture uint, target GLenum, level int, xoffset int, yoffset int, zoffset int, x int, y int, width int, height int) {
...
// Make member?
func DisableVertexArrayAttrib(vaobj uint, index uint) {
	C.glDisableVertexArrayAttribEXT(C.GLuint(vaobj), C.GLuint(index))
}

// Make member?
func DisableVertexArray(vaobj uint, array GLenum) {
...
// Make member?
func GenerateTextureMipmap(texture uint, target GLenum) {
...
func GetCompressedTextureImage(texture uint, target GLenum, level int, img interface{}) {
...
// Make member?
func GetFramebufferParameteriv(framebuffer uint, pname GLenum, params []int32) {
...
// Make member?
func GetNamedBufferParameteriv(buffer uint, pname GLenum, params []int32) {
	C.glGetNamedBufferParameterivEXT(C.GLuint(buffer), C.GLenum(pname), (*C.GLint)(&params[0]))
}

// Make member?
// Slice?
func GetNamedBufferPointerv(buffer uint, pname GLenum) (ptr unsafe.Pointer) {
...
// Make member?
// Slice?
func MapNamedBuffer(buffer uint, access GLenum) unsafe.Pointer {
	return C.glMapNamedBufferEXT(C.GLuint(buffer), C.GLenum(access))
}

// Make member?
// Slice?
func MapNamedBufferRange(buffer uint, offset uintptr, length uintptr, access uint32) unsafe.Pointer {
...
func MultiTexBuffer(texunit GLenum, target GLenum, internalformat GLenum, buffer uint) {
...
func MultiTexRenderbuffer(texunit GLenum, target GLenum, renderbuffer uint) {
...
// Make member?
func NamedBufferData(buffer uint, size uintptr, data interface{}, usage GLenum) {
	C.glNamedBufferDataEXT(C.GLuint(buffer), C.GLsizeiptr(size), glPointer(data), C.GLenum(usage))
}

// Make member?
func NamedBufferSubData(buffer uint, offset uintptr, size uintptr, data interface{}) {
	C.glNamedBufferSubDataEXT(C.GLuint(buffer), C.GLintptr(offset), C.GLsizeiptr(size), glPointer(data))
}

// Make member?
func NamedCopyBufferSubData(readBuffer uint, writeBuffer uint, readOffset uintptr, writeOffset uintptr, size uintptr) {
...
// Make member?
func NamedFramebufferRenderbuffer(framebuffer uint, attachment GLenum, renderbuffertarget GLenum, renderbuffer uint) {
...
// Make member?
func NamedFramebufferTexture1D(framebuffer uint, attachment GLenum, textarget GLenum, texture uint, level int) {
...
// Make member?
func NamedFramebufferTexture2D(framebuffer uint, attachment GLenum, textarget GLenum, texture uint, level int) {
...
// Make member?
func NamedFramebufferTexture3D(framebuffer uint, attachment GLenum, textarget GLenum, texture uint, level int, zoffset int) {
...
// Make member?
func NamedFramebufferTexture(framebuffer uint, attachment GLenum, texture uint, level int) {
	C.glNamedFramebufferTextureEXT(C.GLuint(framebuffer), C.GLenum(attachment), C.GLuint(texture), C.GLint(level))
}

// Make member?
func NamedFramebufferTextureFace(framebuffer uint, attachment GLenum, texture uint, level int, face GLenum) {
	C.glNamedFramebufferTextureFaceEXT(C.GLuint(framebuffer), C.GLenum(attachment), C.GLuint(texture), C.GLint(level), C.GLenum(face))
}

// Make member?
func NamedFramebufferTextureLayer(framebuffer uint, attachment GLenum, texture uint, level int, layer int) {
...
// Make member?
func NamedProgramLocalParameter4d(program uint, target GLenum, index uint, x float64, y float64, z float64, w float64) {
...
// Make member?
func NamedProgramLocalParameter4dv(program uint, target GLenum, index uint, params []float64) {
	C.glNamedProgramLocalParameter4dvEXT(C.GLuint(program), C.GLenum(target), C.GLuint(index), (*C.GLdouble)(&params[0]))
}

// Make member?
func NamedProgramLocalParameter4f(program uint, target GLenum, index uint, x float32, y float32, z float32, w float32) {
...
// Make member?
func NamedProgramLocalParameter4fv(program uint, target GLenum, index uint, params []float32 ) {
	C.glNamedProgramLocalParameter4fvEXT(C.GLuint(program), C.GLenum(target), C.GLuint(index), (*C.GLfloat)(&params[0]))
}

// Make member?
func NamedProgramLocalParameterI4i(program uint, target GLenum, index uint, x int, y int, z int, w int) {
...
// Make member?
func NamedProgramLocalParameterI4iv(program uint, target GLenum, index uint, params []int32) {
	C.glNamedProgramLocalParameterI4ivEXT(C.GLuint(program), C.GLenum(target), C.GLuint(index), (*C.GLint)(&params[0]))
}

// Make member?
func NamedProgramLocalParameterI4ui(program uint, target GLenum, index uint, x uint, y uint, z uint, w uint) {
...
// Make member?
func NamedProgramLocalParameterI4uiv(program uint, target GLenum, index uint, params []uint32) {
	C.glNamedProgramLocalParameterI4uivEXT(C.GLuint(program), C.GLenum(target), C.GLuint(index), (*C.GLuint)(&params[0]))
}

// Make member?
func NamedProgramLocalParameters4fv(program uint, target GLenum, index uint, count int, params []float32) {
	C.glNamedProgramLocalParameters4fvEXT(C.GLuint(program), C.GLenum(target), C.GLuint(index), C.GLsizei(count), (*C.GLfloat)(&params[0]))
}

// Make member?
func NamedProgramLocalParametersI4iv(program uint, target GLenum, index uint, count int, params []int32) {
	C.glNamedProgramLocalParametersI4ivEXT(C.GLuint(program), C.GLenum(target), C.GLuint(index), C.GLsizei(count), (*C.GLint)(&params[0]))
}

// Make member?
func NamedProgramLocalParametersI4uiv(program uint, target GLenum, index uint, count int, params []uint32) {
...
// Make member?
// TODO
// func NamedProgramString(program uint, target GLenum, format GLenum, len int, GLvoid const *string) {
// 	C.glNamedProgramStringEXT(C.GLuint(program), C.GLenum(target), C.GLenum(format), C.GLsizei(len), C.const(GLvoid) *string)
// }

// Make member?
func NamedRenderbufferStorage(renderbuffer uint, internalformat GLenum, width int, height int) {
	C.glNamedRenderbufferStorageEXT(C.GLuint(renderbuffer), C.GLenum(internalformat), C.GLsizei(width), C.GLsizei(height))
}

// Make member?
func NamedRenderbufferStorageMultisampleCoverage(renderbuffer uint, coverageSamples int, colorSamples int, internalformat GLenum, width int, height int) {
...
// Make member?
func NamedRenderbufferStorageMultisample(renderbuffer uint, samples int, internalformat GLenum, width int, height int) {
...
// Make member?
func ProgramUniform1fv(program uint, location int, count int, value []float32) {
...
// Make member?
func ProgramUniform1iv(program uint, location int, count int, value []int32) {
...
// Make member?
func ProgramUniform1uiv(program uint, location int, count int, value []uint32) {
...
// Make member?
func ProgramUniform2fv(program uint, location int, count int, value []float32) {
...
// Make member?
func ProgramUniform2iv(program uint, location int, count int, value []int32) {
...
// Make member?
func ProgramUniform2uiv(program uint, location int, count int, value []uint32) {
...
// Make member?
func ProgramUniform3fv(program uint, location int, count int, value []float32) {
...
// Make member?
func ProgramUniform3iv(program uint, location int, count int, value []int32) {
...
// Make member?
func ProgramUniform3uiv(program uint, location int, count int, value []uint32) {
...
// Make member?
func ProgramUniform4fv(program uint, location int, count int, value []float32) {
...
// Make member?
func ProgramUniform4iv(program uint, location int, count int, value []int32) {
...
// Make member?
func TextureBuffer(texture uint, target GLenum, internalformat GLenum, buffer uint) {
	C.glTextureBufferEXT(C.GLuint(texture), C.GLenum(target), C.GLenum(internalformat), C.GLuint(buffer))
}

// Make member?
func TextureImage1D(texture uint, target GLenum, level int, internalformat int, width int, border int, format GLenum, typ GLenum, pixels interface{}) {
...
// Make member?
func TextureImage2D(texture uint, target GLenum, level int, internalformat int, width int, height int, border int, format GLenum, typ GLenum, pixels interface{}) {
...
// Make member?
func TextureImage3D(texture uint, target GLenum, level int, internalformat int, width int, height int, depth int, border int, format GLenum, typ GLenum, pixels interface{}) {
...
// Make member?
func TextureParameterIiv(texture uint, target GLenum, pname GLenum, params []int32) {
	C.glTextureParameterIivEXT(C.GLuint(texture), C.GLenum(target), C.GLenum(pname), (*C.GLint)(&params[0]))
}

// Make member?
func TextureParameterIuiv(texture uint, target GLenum, pname GLenum, params []uint32) {
	C.glTextureParameterIuivEXT(C.GLuint(texture), C.GLenum(target), C.GLenum(pname), (*C.GLuint)(&params[0]))
}

// Make member?
func TextureParameterf(texture uint, target GLenum, pname GLenum, param float32) {
	C.glTextureParameterfEXT(C.GLuint(texture), C.GLenum(target), C.GLenum(pname), C.GLfloat(param))
}

// Make member?
func TextureParameterfv(texture uint, target GLenum, pname GLenum, param []float32) {
	C.glTextureParameterfvEXT(C.GLuint(texture), C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(&param[0]))
}

// Make member?
func TextureParameteri(texture uint, target GLenum, pname GLenum, param int) {
	C.glTextureParameteriEXT(C.GLuint(texture), C.GLenum(target), C.GLenum(pname), C.GLint(param))
}

// Make member?
func TextureParameteriv(texture uint, target GLenum, pname GLenum, param []int32) {
	C.glTextureParameterivEXT(C.GLuint(texture), C.GLenum(target), C.GLenum(pname), (*C.GLint)(&param[0]))
}

// Make member?
func TextureRenderbuffer(texture uint, target GLenum, renderbuffer uint) {
	C.glTextureRenderbufferEXT(C.GLuint(texture), C.GLenum(target), C.GLuint(renderbuffer))
}

// Make member?
func TextureSubImage1D(texture uint, target GLenum, level int, xoffset int, width int, format GLenum, typ GLenum, pixels interface{}) {
...
// Make member?
func TextureSubImage2D(texture uint, target GLenum, level int, xoffset int, yoffset int, width int, height int, format GLenum, typ GLenum, pixels interface{}) {
...
// Make member?
func TextureSubImage3D(texture uint, target GLenum, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format GLenum, typ GLenum, pixels interface{}) {
...
// Make member?
func UnmapNamedBuffer(buffer uint) bool {
	return goBool(C.glUnmapNamedBufferEXT(C.GLuint(buffer)))
}

// Make member?
func VertexArrayColorOffset(vaobj uint, buffer uint, size int, typ GLenum, stride int, offset uintptr) {
...
// Make member?
func VertexArrayEdgeFlagOffset(vaobj uint, buffer uint, stride int, offset uintptr) {
	C.glVertexArrayEdgeFlagOffsetEXT(C.GLuint(vaobj), C.GLuint(buffer), C.GLsizei(stride), C.GLintptr(offset))
}

// Make member?
func VertexArrayFogCoordOffset(vaobj uint, buffer uint, typ GLenum, stride int, offset uintptr) {
	C.glVertexArrayFogCoordOffsetEXT(C.GLuint(vaobj), C.GLuint(buffer), C.GLenum(typ), C.GLsizei(stride), C.GLintptr(offset))
}

// Make member?
func VertexArrayIndexOffset(vaobj uint, buffer uint, typ GLenum, stride int, offset uintptr) {
	C.glVertexArrayIndexOffsetEXT(C.GLuint(vaobj), C.GLuint(buffer), C.GLenum(typ), C.GLsizei(stride), C.GLintptr(offset))
}

// Make member?
func VertexArrayMultiTexCoordOffset(vaobj uint, buffer uint, texunit GLenum, size int, typ GLenum, stride int, offset uintptr) {
...
// Make member?
func VertexArrayNormalOffset(vaobj uint, buffer uint, typ GLenum, stride int, offset uintptr) {
	C.glVertexArrayNormalOffsetEXT(C.GLuint(vaobj), C.GLuint(buffer), C.GLenum(typ), C.GLsizei(stride), C.GLintptr(offset))
}

// Make member?
func VertexArraySecondaryColorOffset(vaobj uint, buffer uint, size int, typ GLenum, stride int, offset uintptr) {
...
// Make member?
func VertexArrayTexCoordOffset(vaobj uint, buffer uint, size int, typ GLenum, stride int, offset uintptr) {
...
// Make member?
func VertexArrayVertexAttribIOffset(vaobj uint, buffer uint, index uint, size int, typ GLenum, stride int, offset uintptr) {
...
// Make member?
func VertexArrayVertexAttribOffset(vaobj uint, buffer uint, index uint, size int, typ GLenum, normalized bool, stride int, offset uintptr) {
...
// Make member?
func VertexArrayVertexOffset(vaobj uint, buffer uint, size int, typ GLenum, stride int, offset uintptr) {
